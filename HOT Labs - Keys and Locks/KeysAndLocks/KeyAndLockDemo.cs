using KeysAndLocks.Inheritance;
using System;
using System.Collections.Generic;
using System.Linq;

namespace KeysAndLocks
{
    public class KeyAndLockDemo
    {
        ...
        private int PickLock(AbstractLock theLock, int keyLength)
        {
            int count = 0;
        ...
        private bool IncrementKeySequence(int[] sequence)
        {
        ...
        private void DisplayKeySequence(int[] sequence)
        {
